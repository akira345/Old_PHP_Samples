...
//ボタンチェック（これはswitch文を使うとよい。っと言っても２つしかないが・・・）
...
$r=$kouho[$tmp];//当然入れ替えたら動かす数字が合った座標は空白画像の座標になるので代入。
...
$f=0;//フラグを初期化
$L=0;//カウンタ変数を初期化（動かせる画像の数は最大４個。だから１つの画像に対し４回ループをまわす。）
...
while($f==0)
{
	...
	$out="<a href=\"".$phpdir."15puzzle.php?PHPSESSID=$ID&link=$k\">
...
print ("
<FORM method=\"POST\" action=\"15puzzle.php\">
